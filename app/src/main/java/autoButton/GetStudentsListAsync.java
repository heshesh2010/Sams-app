...
public class GetStudentsListAsync extends AsyncTask<Void, Void, Pair> {
	...
	protected void onPostExecute(Pair p) {
		...
		if (p.geterror()=="error") {
			...
			alertDialog.setTitle("ÎØÃ");
			alertDialog.setMessage("íæÌÏ ãÔßáÉ ÈÇáÇÊÕÇá ");

			// Retry Button Action
			alertDialog.setPositiveButton("ÇÚÏ ÇáãÍÇæáÉ",
			...
			// No Button Action
			alertDialog.setNegativeButton("ÑÌæÚ",
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
							progressDialog.dismiss();
			...
			alertDialog
					.setTitle("ÎØÃ ");
			alertDialog.setMessage("ÊÇßÏ ãä ÊæÞíÊ ÇáÍÕÉ ÇáÎÇÕÉ Èß Çæ ÇÚÏ ÇáãÍÇæáÉ ");

			// Retry Button Action
			alertDialog.setPositiveButton("ÇÚÇÏå",
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
			...
			// No Button Action
			alertDialog.setNegativeButton("ÎÑæÌ",
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
							 progressDialog.dismiss();
			...
			alertDialog
					.setTitle("ÎØÃ");
			alertDialog.setMessage("áÇ ÊæÌÏ ÈíÇäÇÊ ÈÑÌÇÁ ÇáÊÇßÏ ãä ÊæÞíÊ ÇáÍÕÉ ");
			...
			try {
				...
				alertDialog.setTitle("ÎØÃ");
				alertDialog.setMessage("ÊÇßÏ ãä ÊæÞíÊ ÌÏæá ÇáÍÕÕ ÇáÎÇÕ Èß Çæ ÊæÇÕá ãÚ ÇáÏÚã ÇáÝäí");
